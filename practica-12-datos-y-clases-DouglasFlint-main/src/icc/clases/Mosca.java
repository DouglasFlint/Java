...
public class Mosca {
    ...
    public String canta() {
        ...
        String newOriginal = original.replace('a', vocal);
        String newOriginal1 = newOriginal.replace('e', vocal);
        String newOriginal2 = newOriginal1.replace('i', vocal);
        String newOriginal3 = newOriginal2.replace('o', vocal);
        String newOriginal4 = newOriginal3.replace('u', vocal);
        

        System.out.println(newOriginal4);
        return "";
    }
}
